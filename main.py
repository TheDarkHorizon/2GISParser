...
TABLE_COLUMNS = ['Name', 'Phone', 'Address', 'Link']
...
def main():
    search_query = 'Торговые центры'
    url = f'https://2gis.ru/yaroslavl/search/{search_query}'
    ...
    for _ in range(pages):
        ...
        for item in range(1, count_items + 1):
            ...
            TABLE['Name'].append(title)
            TABLE['Phone'].append(phone)
